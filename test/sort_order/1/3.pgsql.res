...
(8 rows)
 ...
 peer     | <TESTBASE>/test/local/usr                | MKDIR     |             |  1
 other    | <TESTBASE>/test/local/usr/local          | MKDIR     |             |  1
 peer     | <TESTBASE>/test/local/usr/local          | MKDIR     |             |  1
 other    | <TESTBASE>/test/local/usr/local/abc      | MKDIR     |             |  1
 peer     | <TESTBASE>/test/local/usr/local/abc      | MKDIR     |             |  1
 other    | <TESTBASE>/test/local/usr/local/def      | MKDIR     |             |  1
 peer     | <TESTBASE>/test/local/usr/local/def      | MKDIR     |             |  1
 other    | <TESTBASE>/test/local/usr/local/sbin     | MKDIR     |             |  1
 peer     | <TESTBASE>/test/local/usr/local/sbin     | MKDIR     |             |  1
 other    | <TESTBASE>/test/local/usr/local/def/hej  | NEW       | ../sbin/hej |  2
 peer     | <TESTBASE>/test/local/usr/local/def/hej  | NEW       | ../sbin/hej |  2
 other    | <TESTBASE>/test/local/usr/local/sbin/hej | NEW       |             |  2
 peer     | <TESTBASE>/test/local/usr/local/sbin/hej | NEW       |             |  2
(16 rows)
