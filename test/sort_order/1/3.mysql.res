...
| peer     | <TESTBASE>/test/local/usr                | MKDIR     | NULL        |    1 |
| other    | <TESTBASE>/test/local/usr/local          | MKDIR     | NULL        |    1 |
| peer     | <TESTBASE>/test/local/usr/local          | MKDIR     | NULL        |    1 |
| other    | <TESTBASE>/test/local/usr/local/abc      | MKDIR     | NULL        |    1 |
| peer     | <TESTBASE>/test/local/usr/local/abc      | MKDIR     | NULL        |    1 |
| other    | <TESTBASE>/test/local/usr/local/def      | MKDIR     | NULL        |    1 |
| peer     | <TESTBASE>/test/local/usr/local/def      | MKDIR     | NULL        |    1 |
| other    | <TESTBASE>/test/local/usr/local/sbin     | MKDIR     | NULL        |    1 |
| peer     | <TESTBASE>/test/local/usr/local/sbin     | MKDIR     | NULL        |    1 |
| other    | <TESTBASE>/test/local/usr/local/def/hej  | ???       | ../sbin/hej |    2 |
| peer     | <TESTBASE>/test/local/usr/local/def/hej  | ???       | ../sbin/hej |    2 |
