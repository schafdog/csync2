...
IDENT (cmd_finished).
Command: local: SIG <TESTBASE>/test/peer/usr/local/abc user/group <UID> <GID> <USER> <GROUP> <BLKSIZE> - <DIRSIZE> xxxxxxxx
Command: local: MKDIR <TESTBASE>/test/peer/usr/local/abc - <UID> <GID> <USER> <GROUP> <BLKSIZE> - <DIRSIZE> xxxxxxxx
Running check for <TESTBASE>/test/peer/usr/local/abc ...
Checking for modified files <TESTBASE>/test/peer/usr/local/abc 
Checking for deleted files <TESTBASE>/test/peer/usr/local/abc.
Updated(mkdir) local:<TESTBASE>/test/peer/usr/local/abc  
IDENT (cmd_finished).
Command: local: SIG <TESTBASE>/test/peer/usr/local/def user/group <UID> <GID> <USER> <GROUP> <BLKSIZE> - <DIRSIZE> xxxxxxxx
Command: local: MKDIR <TESTBASE>/test/peer/usr/local/def - <UID> <GID> <USER> <GROUP> <BLKSIZE> - <DIRSIZE> xxxxxxxx
Running check for <TESTBASE>/test/peer/usr/local/def ...
Checking for modified files <TESTBASE>/test/peer/usr/local/def 
Checking for deleted files <TESTBASE>/test/peer/usr/local/def.
Updated(mkdir) local:<TESTBASE>/test/peer/usr/local/def  
IDENT (cmd_finished).
...
IDENT (cmd_finished).
Command: local: SIG <TESTBASE>/test/peer/usr/local/def/hej user/group <UID> <GID> <USER> <GROUP> <BLKSIZE> - <DIRSIZE> xxxxxxxx
Command: local: MKLINK <TESTBASE>/test/peer/usr/local/def/hej ../sbin/hej        
Running check for <TESTBASE>/test/peer/usr/local/def/hej ...
Checking for modified files <TESTBASE>/test/peer/usr/local/def/hej 
Checking for deleted files <TESTBASE>/test/peer/usr/local/def/hej.
Updated(mklink) local:<TESTBASE>/test/peer/usr/local/def/hej ../sbin/hej 
Command: local: SETOWN <TESTBASE>/test/peer/usr/local/def/hej user/group <UID> <GID> <USER> <GROUP> <BLKSIZE> - <DIRSIZE> xxxxxxxx
Running check for <TESTBASE>/test/peer/usr/local/def/hej ...
Checking for modified files <TESTBASE>/test/peer/usr/local/def/hej 
Checking for deleted files <TESTBASE>/test/peer/usr/local/def/hej.
Updated(setown) local:<TESTBASE>/test/peer/usr/local/def/hej  
Command: local: SETTIME <TESTBASE>/test/peer/usr/local/def/hej xxxxxxxx        
...
Command: local: SETTIME <TESTBASE>/test/peer/usr/local/def xxxxxxxx        
...
Removing <TESTBASE>/test/peer/usr/local/def/* ..
Running check for <TESTBASE>/test/peer/usr/local/def/hej ...
Checking for modified files <TESTBASE>/test/peer/usr/local/def/hej 
Checking for deleted files <TESTBASE>/test/peer/usr/local/def/hej.
Removing file <TESTBASE>/test/peer/usr/local/def/hej
Removing <TESTBASE>/test/peer/usr/local/def/hej from file db.
Removing directory <TESTBASE>/test/peer/usr/local/def 0
Removing <TESTBASE>/test/peer/usr/local/abc/* ..
Removing directory <TESTBASE>/test/peer/usr/local/abc 0
