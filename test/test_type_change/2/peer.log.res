...
setown <TESTBASE>/test/peer/type_change rc = 0 gid: <UID> gid: <GID> errno = 22 err = 
setmod <TESTBASE>/test/peer/type_change rc = 0 mod: 16877 errno = 22 err = 
...
CONN local > 'STAT 9iNlOKBHPfeAtRpsCgaQqTwKuGmEVZGB4vCM2ALNvBDDKIZDnoAaK0209kviFLAV %25test%25/type_change user/group'
Command: local: STAT <TESTBASE>/test/peer/type_change user/group <UID> <GID> <USER> <GROUP>    
CONN local < OK (data_follows).

Flags for gencheck: 48 
CONN local < v2%3Amtime=xxxxxxxxxx%3Amode=16877%3Auser=<USER>%3Agroup=<GROUP>%3Atype=dir

CONN local > 'DEL 9iNlOKBHPfeAtRpsCgaQqTwKuGmEVZGB4vCM2ALNvBDDKIZDnoAaK0209kviFLAV %25test%25/type_change '
Command: local: DEL <TESTBASE>/test/peer/type_change         
daemon_check_dirty: <TESTBASE>/test/peer/type_change
Running check for <TESTBASE>/test/peer/type_change ...
Checking for modified files <TESTBASE>/test/peer/type_change 
Checking for deleted files <TESTBASE>/test/peer/type_change.
...
Updated(del) local:<TESTBASE>/test/peer/type_change  
Daemon end_command <TESTBASE>/test/peer/type_change DEL 1 
IDENT (cmd_finished).
CONN local < IDENT (cmd_finished).
