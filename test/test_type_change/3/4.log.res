...
DIRTY LOOKUP: '<TESTBASE>/test/local/type_change' 'v2:mtime=<MTIME>mode=33188:user=<USER>:group=<GROUP>:type=reg:size=9'
compare file with pattern <TESTBASE>/test/local
dirty: peer:<TESTBASE>/test/local/type_change v2:mtime=xxxxxxxxxx:mode=33188:user=<USER>:group=<GROUP>:type=reg:size=9 ''
...
has links: file <TESTBASE>/test/local/type_change checktxt 'v2:mtime=<MTIME>mode=33188:user=<USER>:group=<GROUP>:type=reg:size=9' 1 true
...
Reading chunk 15 bytes of 15 from file
Writing chunk 15 bytes of 15
