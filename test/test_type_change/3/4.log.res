...
SQL: SELECT operation, filename, other, checktxt, digest, op FROM dirty WHERE myname = 'local' AND (checktxt = 'v2:mtime=1736899567:mode=16877:user=dennis:group=schafroth:type=dir' AND device = 2049 AND inode = 53346620 OR filename = '<TESTBASE>/test/local') AND peername = 'peer' ORDER BY timestamp 
SQL Query finished.
csync2_db_SQL: DELETE FROM dirty WHERE  filename = '<TESTBASE>/test/local'  AND  myname = 'local' AND peername like 'peer'
csync2_db_SQL: INSERT INTO dirty (filename, forced, myname, peername, operation, checktxt, device, inode, other, op, mode, type, mtime) VALUES ('<TESTBASE>/test/local', 0, 'local', 'peer', 'MKDIR', 'v2:mtime=1736899567:mode=16877:user=dennis:group=schafroth:type=dir', 2049, 53346620, NULL, 129, 16877, 1, 1736899567)
mark other operation: 'MOD_DIR' 'other:<TESTBASE>/test/local' '-'.
SQL: SELECT operation, filename, other, checktxt, digest, op FROM dirty WHERE myname = 'local' AND (checktxt = 'v2:mtime=1736899567:mode=16877:user=dennis:group=schafroth:type=dir' AND device = 2049 AND inode = 53346620 OR filename = '<TESTBASE>/test/local') AND peername = 'other' ORDER BY timestamp 
SQL Query finished.
...
csync2_db_SQL: INSERT INTO dirty (filename, forced, myname, peername, operation, checktxt, device, inode, other, op, mode, type, mtime) VALUES ('<TESTBASE>/test/local', 0, 'local', 'other', 'MKDIR', 'v2:mtime=1736899567:mode=16877:user=dennis:group=schafroth:type=dir', 2049, 53346620, NULL, 1, 16877, 1, 1736899567)
INSERT/UPDATE: <TESTBASE>/test/local 
csync2_db_SQL: UPDATE file set checktxt='v2:mtime=1736899567:mode=16877:user=dennis:group=schafroth:type=dir', device=2049, inode=53346620,                 digest='', mode=16877, mtime=1736899567, size=4096, type=1 where filename = '<TESTBASE>/test/local'
...
SQL: SELECT operation, filename, other, checktxt, digest, op FROM dirty WHERE myname = 'local' AND (checktxt = 'v2:mtime=1736899567:mode=33188:user=dennis:group=schafroth:type=reg:size=9' AND device = 2049 AND inode = 53346621 OR filename = '<TESTBASE>/test/local/type_change') AND peername = 'peer' ORDER BY timestamp 
SQL Query finished.
csync2_db_SQL: DELETE FROM dirty WHERE  filename = '<TESTBASE>/test/local/type_change'  AND  myname = 'local' AND peername like 'peer'
csync2_db_SQL: INSERT INTO dirty (filename, forced, myname, peername, operation, checktxt, device, inode, other, op, mode, type, mtime) VALUES ('<TESTBASE>/test/local/type_change', 0, 'local', 'peer', 'NEW', 'v2:mtime=1736899567:mode=33188:user=dennis:group=schafroth:type=reg:size=9', 2049, 53346621, NULL, 258, 33188, 2, 1736899567)
mark other operation: 'MOD' 'other:<TESTBASE>/test/local/type_change' '-'.
SQL: SELECT operation, filename, other, checktxt, digest, op FROM dirty WHERE myname = 'local' AND (checktxt = 'v2:mtime=1736899567:mode=33188:user=dennis:group=schafroth:type=reg:size=9' AND device = 2049 AND inode = 53346621 OR filename = '<TESTBASE>/test/local/type_change') AND peername = 'other' ORDER BY timestamp 
SQL Query finished.
...
csync2_db_SQL: INSERT INTO dirty (filename, forced, myname, peername, operation, checktxt, device, inode, other, op, mode, type, mtime) VALUES ('<TESTBASE>/test/local/type_change', 0, 'local', 'other', 'MKDIR', 'v2:mtime=1736899567:mode=33188:user=dennis:group=schafroth:type=reg:size=9', 2049, 53346621, NULL, 1, 33188, 2, 1736899567)
INSERT/UPDATE: <TESTBASE>/test/local/type_change 
csync2_db_SQL: UPDATE file set checktxt='v2:mtime=1736899567:mode=33188:user=dennis:group=schafroth:type=reg:size=9', device=2049, inode=53346621,                 digest='', mode=33188, mtime=1736899567, size=9, type=2 where filename = '<TESTBASE>/test/local/type_change'
...
csync2_db_SQL: INSERT INTO dirty (filename, forced, myname, peername, operation, checktxt, device, inode, other, op, mode, type, mtime) VALUES ('<TESTBASE>/test/local/type_change/new_file ''N'' all', 0, 'local', 'peer', 'RM', 'v2:mtime=1736899564:mode=33188:user=dennis:group=schafroth:type=reg:size=4', 2049, 53346622, NULL, 64, 33188, 2, 1736899567)
...
compare file with pattern <TESTBASE>/test/local
dirty: peer:<TESTBASE>/test/local/type_change v2:mtime=1736899567:mode=33188:user=dennis:group=schafroth:type=reg:size=9 ''
DIRTY LOOKUP: '<TESTBASE>/test/local' ''
compare file with pattern <TESTBASE>/test/local
dirty: peer:<TESTBASE>/test/local v2:mtime=1736899567:mode=16877:user=dennis:group=schafroth:type=dir ''
SQL Query finished.
...
Redis reply: SET '<TESTBASE>/test/local' '1736899567' NX EX 60 -> OK
...
has links: file <TESTBASE>/test/local checktxt 'v2:mtime=1736899567:mode=16877:user=dennis:group=schafroth:type=dir' 2 0
MKDIR rc: 16
...
Redis reply: SET '<TESTBASE>/test/local/type_change' '1736899567' NX EX 60 -> OK
...
has links: file <TESTBASE>/test/local/type_change checktxt 'v2:mtime=1736899567:mode=33188:user=dennis:group=schafroth:type=reg:size=9' 1 1
