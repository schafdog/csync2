...
csync2_db_SQL: INSERT INTO dirty (filename, forced, myname, peername, operation, checktxt, device, inode, other, op, mode, type, mtime) VALUES ('<TESTBASE>/test/local', 0, 'local', 'peer', 'MKDIR', 'v2:mtime=1736899571:mode=16877:user=dennis:group=schafroth:type=dir', 2049, 53346620, NULL, 129, 16877, 1, 1736899571)
...
csync2_db_SQL: INSERT INTO dirty (filename, forced, myname, peername, operation, checktxt, device, inode, other, op, mode, type, mtime) VALUES ('<TESTBASE>/test/local', 0, 'local', 'other', 'MKDIR', 'v2:mtime=1736899571:mode=16877:user=dennis:group=schafroth:type=dir', 2049, 53346620, NULL, 1, 16877, 1, 1736899571)
INSERT/UPDATE: <TESTBASE>/test/local 
csync2_db_SQL: UPDATE file set checktxt='v2:mtime=1736899571:mode=16877:user=dennis:group=schafroth:type=dir', device=2049, inode=53346620,                 digest='', mode=16877, mtime=1736899571, size=4096, type=1 where filename = '<TESTBASE>/test/local'
...
csync2_db_SQL: INSERT INTO dirty (filename, forced, myname, peername, operation, checktxt, device, inode, other, op, mode, type, mtime) VALUES ('<TESTBASE>/test/local/type_change', 0, 'local', 'peer', 'NEW', 'v2:mtime=1736899571:mode=33188:user=dennis:group=schafroth:type=reg:size=11', 2049, 53346621, NULL, 258, 33188, 2, 1736899571)
...
csync2_db_SQL: INSERT INTO dirty (filename, forced, myname, peername, operation, checktxt, device, inode, other, op, mode, type, mtime) VALUES ('<TESTBASE>/test/local/type_change', 0, 'local', 'other', 'MKDIR', 'v2:mtime=1736899571:mode=33188:user=dennis:group=schafroth:type=reg:size=11', 2049, 53346621, NULL, 1, 33188, 2, 1736899571)
INSERT/UPDATE: <TESTBASE>/test/local/type_change 
csync2_db_SQL: UPDATE file set checktxt='v2:mtime=1736899571:mode=33188:user=dennis:group=schafroth:type=reg:size=11', device=2049, inode=53346621,                 digest='', mode=33188, mtime=1736899571, size=11, type=2 where filename = '<TESTBASE>/test/local/type_change'
...
csync2_db_SQL: INSERT INTO dirty (filename, forced, myname, peername, operation, checktxt, device, inode, other, op, mode, type, mtime) VALUES ('<TESTBASE>/test/local/type_change/new_file ''N'' all', 0, 'local', 'peer', 'RM', 'v2:mtime=1736899568:mode=33188:user=dennis:group=schafroth:type=reg:size=4', 2049, 53346656, NULL, 64, 33188, 2, 1736899571)
...
Redis reply: SET '<TESTBASE>/test/local' '1736899571' NX EX 60 -> OK
csync_redis_lock: OK <TESTBASE>/test/local 1736899571
Match (+): <TESTBASE>/test/local on <TESTBASE>/test/local
...
has links: file <TESTBASE>/test/local checktxt 'v2:mtime=1736899571:mode=16877:user=dennis:group=schafroth:type=dir' 2 0
MKDIR rc: 16
...
Redis reply: SET '<TESTBASE>/test/local/type_change' '1736899571' NX EX 60 -> OK
csync_redis_lock: OK <TESTBASE>/test/local/type_change 1736899571
Match (+): <TESTBASE>/test/local on <TESTBASE>/test/local/type_change
uid dennis gid schafroth
...
has links: file <TESTBASE>/test/local/type_change checktxt 'v2:mtime=1736899571:mode=33188:user=dennis:group=schafroth:type=reg:size=11' 1 1
...
Match (+): <TESTBASE>/test/local on <TESTBASE>/test/local
uid dennis gid schafroth
update_directory: Setting directory time <TESTBASE>/test/local 1736899571.
