...
csync2_db_SQL: INSERT INTO dirty (filename, forced, myname, peername, operation, checktxt, device, inode, other, op, mode, type, mtime) VALUES ('/export/home/dennis/Projects/csync2/csync2/test/test/local', 0, 'local', 'peer', 'MKDIR', 'v2:mtime=1736899558:mode=16877:user=dennis:group=schafroth:type=dir', 2049, 53091034, NULL, 1, 16877, 1, 1736899558)
...
csync2_db_SQL: INSERT INTO dirty (filename, forced, myname, peername, operation, checktxt, device, inode, other, op, mode, type, mtime) VALUES ('/export/home/dennis/Projects/csync2/csync2/test/test/local', 0, 'local', 'other', 'MKDIR', 'v2:mtime=1736899558:mode=16877:user=dennis:group=schafroth:type=dir', 2049, 53091034, NULL, 1, 16877, 1, 1736899558)
INSERT/UPDATE: /export/home/dennis/Projects/csync2/csync2/test/test/local 
csync2_db_SQL: UPDATE file set checktxt='v2:mtime=1736899558:mode=16877:user=dennis:group=schafroth:type=dir', device=2049, inode=53091034,                 digest='', mode=16877, mtime=1736899558, size=4096, type=1 where filename = '/export/home/dennis/Projects/csync2/csync2/test/test/local'
...
Match (+): /export/home/dennis/Projects/csync2/csync2/test/test/local on /export/home/dennis/Projects/csync2/csync2/test/test/local/B
SQL: SELECT checktxt, inode, device, digest, mode, size, mtime FROM file WHERE hostname = 'local' AND filename = '/export/home/dennis/Projects/csync2/csync2/test/test/local/B' 
...
SQL:  SELECT filename, checktxt, digest FROM file WHERE  hostname = 'local'  AND device = 2049  AND inode = 53091035  AND filename != '/export/home/dennis/Projects/csync2/csync2/test/test/local/B' 
Adding textlist_add_new: /export/home/dennis/Projects/csync2/csync2/test/test/local/Z
1 files with same dev:inode (2049:53091035) as file: /export/home/dennis/Projects/csync2/csync2/test/test/local/B
SQL Query finished.
...
csync2_db_SQL: DELETE FROM file WHERE  filename = '/export/home/dennis/Projects/csync2/csync2/test/test/local/Z'  AND  hostname = 'local'
...
SQL: SELECT operation, filename, other, checktxt, digest, op FROM dirty WHERE myname = 'local' AND (checktxt = 'v2:mtime=1736899555:mode=33188:user=dennis:group=schafroth:type=reg:size=2' AND device = 2049 AND inode = 53091035 OR filename = '/export/home/dennis/Projects/csync2/csync2/test/test/local/B') AND peername = 'peer' ORDER BY timestamp 
SQL Query finished.
mark other: MV(16) Old operation: NEW(2) '/export/home/dennis/Projects/csync2/csync2/test/test/local/Z' ''
...
Found row: file '/export/home/dennis/Projects/csync2/csync2/test/test/local/B' clean_other: '/export/home/dennis/Projects/csync2/csync2/test/test/local/Z' result_other: '(null)' dirty: 1 operation 2 
...
csync2_db_SQL: INSERT INTO dirty (filename, forced, myname, peername, operation, checktxt, device, inode, other, op, mode, type, mtime) VALUES ('/export/home/dennis/Projects/csync2/csync2/test/test/local/B', 0, 'local', 'peer', 'NEW', 'v2:mtime=1736899555:mode=33188:user=dennis:group=schafroth:type=reg:size=2', 2049, 53091035, NULL, 2, 33188, 2, 1736899555)
...
SQL: SELECT operation, filename, other, checktxt, digest, op FROM dirty WHERE myname = 'local' AND (checktxt = 'v2:mtime=1736899555:mode=33188:user=dennis:group=schafroth:type=reg:size=2' AND device = 2049 AND inode = 53091035 OR filename = '/export/home/dennis/Projects/csync2/csync2/test/test/local/B') AND peername = 'other' ORDER BY timestamp 
SQL Query finished.
mark other: MV(16) Old operation: NEW(2) '/export/home/dennis/Projects/csync2/csync2/test/test/local/Z' ''
...
csync2_db_SQL: INSERT INTO dirty (filename, forced, myname, peername, operation, checktxt, device, inode, other, op, mode, type, mtime) VALUES ('/export/home/dennis/Projects/csync2/csync2/test/test/local/B', 0, 'local', 'other', 'NEW', 'v2:mtime=1736899555:mode=33188:user=dennis:group=schafroth:type=reg:size=2', 2049, 53091035, NULL, 2, 33188, 2, 1736899555)
INSERT/UPDATE: /export/home/dennis/Projects/csync2/csync2/test/test/local/B 7d157d7c000ae27db146575c08ce30df893d3a64
csync2_db_SQL: INSERT INTO file (hostname, filename, checktxt, device, inode, digest, mode, size, mtime, type) VALUES ('local', '/export/home/dennis/Projects/csync2/csync2/test/test/local/B', 'v2:mtime=1736899555:mode=33188:user=dennis:group=schafroth:type=reg:size=2', 2049, 53091035, '7d157d7c000ae27db146575c08ce30df893d3a64', 33188, 2, 1736899555, 2) ON CONFLICT (filename, hostname) DO UPDATE SET checktxt = 'v2:mtime=1736899555:mode=33188:user=dennis:group=schafroth:type=reg:size=2', device = 2049, inode = 53091035, digest = '7d157d7c000ae27db146575c08ce30df893d3a64', mode = 33188, size = 2, mtime = 1736899555, type = 2
Inserted/updated /export/home/dennis/Projects/csync2/csync2/test/test/local/B rows matched: 0
...
Match (+): /export/home/dennis/Projects/csync2/csync2/test/test/local on /export/home/dennis/Projects/csync2/csync2/test/test/local/B
check_pure: filename: '/export/home/dennis/Projects/csync2/csync2/test/test/local/B' 59, cached path: '/export/home/dennis/Projects/csync2/csync2/test/test/' 53, 53.
SQL Query finished.
