...
csync2_db_SQL: INSERT INTO dirty (filename, forced, myname, peername, operation, checktxt, device, inode, other, op, mode, type, mtime) VALUES ('<TESTBASE>/test/local', 0, 'local', 'peer', 'MKDIR', 'v2:mtime=<MTIME>mode=16877:user=<USER>:group=<GROUP>:type=dir', 2049, 53091034, NULL, 1, 16877, 1, 1736899556)
...
csync2_db_SQL: INSERT INTO dirty (filename, forced, myname, peername, operation, checktxt, device, inode, other, op, mode, type, mtime) VALUES ('<TESTBASE>/test/local', 0, 'local', 'other', 'MKDIR', 'v2:mtime=<MTIME>mode=16877:user=<USER>:group=<GROUP>:type=dir', 2049, 53091034, NULL, 1, 16877, 1, 1736899556)
INSERT/UPDATE: <TESTBASE>/test/local 
csync2_db_SQL: UPDATE file set checktxt='v2:mtime=<MTIME>mode=16877:user=<USER>:group=<GROUP>:type=dir', device=2049, inode=53091034,                 digest='', mode=16877, mtime=1736899556, size=4096, type=1 where filename = '<TESTBASE>/test/local'
...
SQL: SELECT operation, filename, other, checktxt, digest, op FROM dirty WHERE myname = 'local' AND (checktxt = 'v2:mtime=<MTIME>mode=33188:user=<USER>:group=<GROUP>:type=reg:size=2' AND device = <DEV> AND inode = <INODE>  OR filename = '<TESTBASE>/test/local/Z') AND peername = 'peer' ORDER BY timestamp 
SQL Query finished.
...
csync2_db_SQL: INSERT INTO dirty (filename, forced, myname, peername, operation, checktxt, device, inode, other, op, mode, type, mtime) VALUES ('<TESTBASE>/test/local/Z', 0, 'local', 'peer', 'NEW', 'v2:mtime=<MTIME>mode=33188:user=<USER>:group=<GROUP>:type=reg:size=2', 2049, 53091035, NULL, 2, 33188, 2, 1736899555)
mark other operation: 'MV' 'other:<TESTBASE>/test/local/Z' '<TESTBASE>/test/local/A'.
SQL: SELECT operation, filename, other, checktxt, digest, op FROM dirty WHERE myname = 'local' AND (checktxt = 'v2:mtime=<MTIME>mode=33188:user=<USER>:group=<GROUP>:type=reg:size=2' AND device = <DEV> AND inode = <INODE>  OR filename = '<TESTBASE>/test/local/Z') AND peername = 'other' ORDER BY timestamp 
SQL Query finished.
mark other: MV(16) Old operation: NEW(2) '<TESTBASE>/test/local/A' ''
...
csync2_db_SQL: INSERT INTO dirty (filename, forced, myname, peername, operation, checktxt, device, inode, other, op, mode, type, mtime) VALUES ('<TESTBASE>/test/local/Z', 0, 'local', 'other', 'NEW', 'v2:mtime=<MTIME>mode=33188:user=<USER>:group=<GROUP>:type=reg:size=2', 2049, 53091035, NULL, 2, 33188, 2, 1736899555)
INSERT/UPDATE: <TESTBASE>/test/local/Z 7d157d7c000ae27db146575c08ce30df893d3a64
csync2_db_SQL: INSERT INTO file (hostname, filename, checktxt, device, inode, digest, mode, size, mtime, type) VALUES ('local', '<TESTBASE>/test/local/Z', 'v2:mtime=<MTIME>mode=33188:user=<USER>:group=<GROUP>:type=reg:size=2', 2049, 53091035, '7d157d7c000ae27db146575c08ce30df893d3a64', 33188, 2, 1736899555, 2) ON CONFLICT (filename, hostname) DO UPDATE SET checktxt = 'v2:mtime=<MTIME>mode=33188:user=<USER>:group=<GROUP>:type=reg:size=2', device = 2049, inode = 53091035, digest = '7d157d7c000ae27db146575c08ce30df893d3a64', mode = 33188, size = 2, mtime = 1736899555, type = 2
