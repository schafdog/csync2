...
Daemon end_command <TESTBASE>/test/peer/.Test SIG 0 
CONN local < OK (cmd_finished).
...
Signature has been sent to peer successfully.
Daemon end_command <TESTBASE>/test/peer/A SIG 0 
CONN local < OK (cmd_finished).
...
Signature has been sent to peer successfully.
Daemon end_command <TESTBASE>/test/peer/new_file 'N' all SIG 0 
CONN local < OK (cmd_finished).
