...
Updated(patch) local:<TESTBASE>/test/peer/a/1/d/f1.txt  
IDENT (cmd_finished).
...
Updated(patch) local:<TESTBASE>/test/peer/a/1/e/f1.txt  
IDENT (cmd_finished).
...
Updated(patch) local:<TESTBASE>/test/peer/a/1/f/f1.txt  
IDENT (cmd_finished).
...
Updated(patch) local:<TESTBASE>/test/peer/a/1/f1.txt  
IDENT (cmd_finished).
...
Updated(patch) local:<TESTBASE>/test/peer/a/2/d/f1.txt  
IDENT (cmd_finished).
...
Updated(patch) local:<TESTBASE>/test/peer/a/2/e/f1.txt  
IDENT (cmd_finished).
...
Updated(patch) local:<TESTBASE>/test/peer/a/2/f/f1.txt  
IDENT (cmd_finished).
...
Updated(patch) local:<TESTBASE>/test/peer/a/2/f1.txt  
IDENT (cmd_finished).
...
Updated(patch) local:<TESTBASE>/test/peer/a/3/d/f1.txt  
IDENT (cmd_finished).
...
Updated(patch) local:<TESTBASE>/test/peer/a/3/e/f1.txt  
IDENT (cmd_finished).
...
Updated(patch) local:<TESTBASE>/test/peer/a/3/f/f1.txt  
IDENT (cmd_finished).
...
Updated(patch) local:<TESTBASE>/test/peer/a/3/f1.txt  
IDENT (cmd_finished).
...
Updated(patch) local:<TESTBASE>/test/peer/a/f1.txt  
IDENT (cmd_finished).
...
Updated(patch) local:<TESTBASE>/test/peer/b/1/d/f1.txt  
IDENT (cmd_finished).
...
Updated(patch) local:<TESTBASE>/test/peer/b/1/e/f1.txt  
IDENT (cmd_finished).
...
Updated(patch) local:<TESTBASE>/test/peer/b/1/f/f1.txt  
IDENT (cmd_finished).
...
Updated(patch) local:<TESTBASE>/test/peer/b/1/f1.txt  
IDENT (cmd_finished).
...
Updated(patch) local:<TESTBASE>/test/peer/b/2/d/f1.txt  
IDENT (cmd_finished).
...
Updated(patch) local:<TESTBASE>/test/peer/b/2/e/f1.txt  
IDENT (cmd_finished).
...
Updated(patch) local:<TESTBASE>/test/peer/b/2/f/f1.txt  
IDENT (cmd_finished).
...
Updated(patch) local:<TESTBASE>/test/peer/b/2/f1.txt  
IDENT (cmd_finished).
...
Updated(patch) local:<TESTBASE>/test/peer/b/3/d/f1.txt  
IDENT (cmd_finished).
...
Updated(patch) local:<TESTBASE>/test/peer/b/3/e/f1.txt  
IDENT (cmd_finished).
...
Updated(patch) local:<TESTBASE>/test/peer/b/3/f/f1.txt  
IDENT (cmd_finished).
...
Updated(patch) local:<TESTBASE>/test/peer/b/3/f1.txt  
IDENT (cmd_finished).
...
Updated(patch) local:<TESTBASE>/test/peer/b/f1.txt  
IDENT (cmd_finished).
...
Updated(patch) local:<TESTBASE>/test/peer/c/1/d/f1.txt  
IDENT (cmd_finished).
...
Updated(patch) local:<TESTBASE>/test/peer/c/1/e/f1.txt  
IDENT (cmd_finished).
...
Updated(patch) local:<TESTBASE>/test/peer/c/1/f/f1.txt  
IDENT (cmd_finished).
...
Updated(patch) local:<TESTBASE>/test/peer/c/1/f1.txt  
IDENT (cmd_finished).
...
Updated(patch) local:<TESTBASE>/test/peer/c/2/d/f1.txt  
IDENT (cmd_finished).
...
Updated(patch) local:<TESTBASE>/test/peer/c/2/e/f1.txt  
IDENT (cmd_finished).
...
Updated(patch) local:<TESTBASE>/test/peer/c/2/f/f1.txt  
IDENT (cmd_finished).
...
Updated(patch) local:<TESTBASE>/test/peer/c/2/f1.txt  
IDENT (cmd_finished).
...
Updated(patch) local:<TESTBASE>/test/peer/c/3/d/f1.txt  
IDENT (cmd_finished).
...
Updated(patch) local:<TESTBASE>/test/peer/c/3/e/f1.txt  
IDENT (cmd_finished).
...
Updated(patch) local:<TESTBASE>/test/peer/c/3/f/f1.txt  
IDENT (cmd_finished).
...
Updated(patch) local:<TESTBASE>/test/peer/c/3/f1.txt  
IDENT (cmd_finished).
...
Updated(patch) local:<TESTBASE>/test/peer/c/f1.txt  
IDENT (cmd_finished).
goto nofork.
Command: HELLO local
HELLO from local. Response: OK
...
Called csync_rmdir_recursive local:<TESTBASE>/test/peer. RC: 1
