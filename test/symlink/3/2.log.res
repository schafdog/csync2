...
dirty host other 
dirty host peer 
DIRTY LOOKUP: '<TESTBASE>/test/local/new_file 'N' all.link' 'v2:mtime=<MTIME>mode=<LINK>:user=<USER>:group=<GROUP>:type=lnk:target=new_file 'N' all'
...
has links: file <TESTBASE>/test/local/new_file 'N' all.link checktxt 'v2:mtime=<MTIME>mode=<LINK>:user=<USER>:group=<GROUP>:type=lnk:target=new_file 'N' all' 1 false
