...
csync2_db_SQL: INSERT INTO dirty (filename, forced, myname, peername, operation, checktxt, device, inode, other, op, mode, type, mtime) VALUES ('<TESTBASE>/test/local/usr/local', 0, 'local', 'peer', 'MKDIR', 'v2:mtime=1736899551:mode=16877:user=dennis:group=schafroth:type=dir', 2049, 53090893, NULL, 129, 16877, 1, 1736899551)
...
csync2_db_SQL: INSERT INTO dirty (filename, forced, myname, peername, operation, checktxt, device, inode, other, op, mode, type, mtime) VALUES ('<TESTBASE>/test/local/usr/local', 0, 'local', 'other', 'MKDIR', 'v2:mtime=1736899551:mode=16877:user=dennis:group=schafroth:type=dir', 2049, 53090893, NULL, 1, 16877, 1, 1736899551)
INSERT/UPDATE: <TESTBASE>/test/local/usr/local 
csync2_db_SQL: UPDATE file set checktxt='v2:mtime=1736899551:mode=16877:user=dennis:group=schafroth:type=dir', device=2049, inode=53090893,                 digest='', mode=16877, mtime=1736899551, size=4096, type=1 where filename = '<TESTBASE>/test/local/usr/local'
...
SQL: SELECT operation, filename, other, checktxt, digest, op FROM dirty WHERE myname = 'local' AND (checktxt = 'v2:mtime=1736899553:mode=16877:user=dennis:group=schafroth:type=dir' AND device = 2049 AND inode = 53090894 OR filename = '<TESTBASE>/test/local/usr/local/sbin') AND peername = 'peer' ORDER BY timestamp 
SQL Query finished.
...
csync2_db_SQL: INSERT INTO dirty (filename, forced, myname, peername, operation, checktxt, device, inode, other, op, mode, type, mtime) VALUES ('<TESTBASE>/test/local/usr/local/sbin', 0, 'local', 'peer', 'MKDIR', 'v2:mtime=1736899553:mode=16877:user=dennis:group=schafroth:type=dir', 2049, 53090894, NULL, 129, 16877, 1, 1736899553)
mark other operation: 'MOD_DIR' 'other:<TESTBASE>/test/local/usr/local/sbin' '-'.
SQL: SELECT operation, filename, other, checktxt, digest, op FROM dirty WHERE myname = 'local' AND (checktxt = 'v2:mtime=1736899553:mode=16877:user=dennis:group=schafroth:type=dir' AND device = 2049 AND inode = 53090894 OR filename = '<TESTBASE>/test/local/usr/local/sbin') AND peername = 'other' ORDER BY timestamp 
SQL Query finished.
...
csync2_db_SQL: INSERT INTO dirty (filename, forced, myname, peername, operation, checktxt, device, inode, other, op, mode, type, mtime) VALUES ('<TESTBASE>/test/local/usr/local/sbin', 0, 'local', 'other', 'MKDIR', 'v2:mtime=1736899553:mode=16877:user=dennis:group=schafroth:type=dir', 2049, 53090894, NULL, 1, 16877, 1, 1736899553)
INSERT/UPDATE: <TESTBASE>/test/local/usr/local/sbin 
csync2_db_SQL: UPDATE file set checktxt='v2:mtime=1736899553:mode=16877:user=dennis:group=schafroth:type=dir', device=2049, inode=53090894,                 digest='', mode=16877, mtime=1736899553, size=4096, type=1 where filename = '<TESTBASE>/test/local/usr/local/sbin'
...
SQL: SELECT operation, filename, other, checktxt, digest, op FROM dirty WHERE myname = 'local' AND (checktxt = 'v2:mtime=1736899553:mode=33188:user=dennis:group=schafroth:type=reg:size=4' AND device = 2049 AND inode = 53091096 OR filename = '<TESTBASE>/test/local/usr/local/sbin/hej') AND peername = 'peer' ORDER BY timestamp 
SQL Query finished.
...
csync2_db_SQL: INSERT INTO dirty (filename, forced, myname, peername, operation, checktxt, device, inode, other, op, mode, type, mtime) VALUES ('<TESTBASE>/test/local/usr/local/sbin/hej', 0, 'local', 'peer', 'NEW', 'v2:mtime=1736899553:mode=33188:user=dennis:group=schafroth:type=reg:size=4', 2049, 53091096, NULL, 2, 33188, 2, 1736899553)
mark other operation: 'NEW' 'other:<TESTBASE>/test/local/usr/local/sbin/hej' '-'.
SQL: SELECT operation, filename, other, checktxt, digest, op FROM dirty WHERE myname = 'local' AND (checktxt = 'v2:mtime=1736899553:mode=33188:user=dennis:group=schafroth:type=reg:size=4' AND device = 2049 AND inode = 53091096 OR filename = '<TESTBASE>/test/local/usr/local/sbin/hej') AND peername = 'other' ORDER BY timestamp 
SQL Query finished.
...
csync2_db_SQL: INSERT INTO dirty (filename, forced, myname, peername, operation, checktxt, device, inode, other, op, mode, type, mtime) VALUES ('<TESTBASE>/test/local/usr/local/sbin/hej', 0, 'local', 'other', 'NEW', 'v2:mtime=1736899553:mode=33188:user=dennis:group=schafroth:type=reg:size=4', 2049, 53091096, NULL, 2, 33188, 2, 1736899553)
INSERT/UPDATE: <TESTBASE>/test/local/usr/local/sbin/hej 32a0617aab4c9fe725f1b5bc441291180ad25b73
csync2_db_SQL: INSERT INTO file (hostname, filename, checktxt, device, inode, digest, mode, size, mtime, type) VALUES ('local', '<TESTBASE>/test/local/usr/local/sbin/hej', 'v2:mtime=1736899553:mode=33188:user=dennis:group=schafroth:type=reg:size=4', 2049, 53091096, '32a0617aab4c9fe725f1b5bc441291180ad25b73', 33188, 4, 1736899553, 2) ON CONFLICT (filename, hostname) DO UPDATE SET checktxt = 'v2:mtime=1736899553:mode=33188:user=dennis:group=schafroth:type=reg:size=4', device = 2049, inode = 53091096, digest = '32a0617aab4c9fe725f1b5bc441291180ad25b73', mode = 33188, size = 4, mtime = 1736899553, type = 2
...
dirty: peer:<TESTBASE>/test/local/usr/local/sbin/hej v2:mtime=1736899553:mode=33188:user=dennis:group=schafroth:type=reg:size=4 ''
DIRTY LOOKUP: '<TESTBASE>/test/local/usr/local/sbin' ''
compare file with pattern <TESTBASE>/test
dirty: peer:<TESTBASE>/test/local/usr/local/sbin v2:mtime=1736899553:mode=16877:user=dennis:group=schafroth:type=dir ''
...
Redis reply: SET '<TESTBASE>/test/local/usr/local' '1736899553' NX EX 60 -> OK
...
has links: file <TESTBASE>/test/local/usr/local checktxt 'v2:mtime=1736899551:mode=16877:user=dennis:group=schafroth:type=dir' 3 0
...
Redis reply: SET '<TESTBASE>/test/local/usr/local/sbin' '1736899553' NX EX 60 -> OK
...
has links: file <TESTBASE>/test/local/usr/local/sbin checktxt 'v2:mtime=1736899553:mode=16877:user=dennis:group=schafroth:type=dir' 2 0
MKDIR rc: 16
...
Redis reply: SET '<TESTBASE>/test/local/usr/local/sbin/hej' '1736899553' NX EX 60 -> OK
...
has links: file <TESTBASE>/test/local/usr/local/sbin/hej checktxt 'v2:mtime=1736899553:mode=33188:user=dennis:group=schafroth:type=reg:size=4' 1 1
