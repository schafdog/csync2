...
dirty host other 
dirty host peer 
DIRTY LOOKUP: '<TESTBASE>/test/local/auto/older/update_both' 'v2:mtime=<MTIME>mode=33188:user=<USER>:group=<GROUP>:type=reg:size=14'
...
has links: file <TESTBASE>/test/local/auto/older/update_both checktxt 'v2:mtime=<MTIME>mode=33188:user=<USER>:group=<GROUP>:type=reg:size=14' 1 true
