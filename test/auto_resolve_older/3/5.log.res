...
SQL:  SELECT filename, checktxt, digest FROM file WHERE  hostname = 'local'  AND device = 2049  AND inode = 53088266  AND filename != '<TESTBASE>/test/local/auto/older/update_both' 
SQL Query finished.
Match (+): <TESTBASE>/test/local/auto/older on <TESTBASE>/test/local/auto/older/update_both
...
SQL: SELECT operation, filename, other, checktxt, digest, op FROM dirty WHERE myname = 'local' AND (checktxt = 'v2:mtime=1623175200:mode=33188:user=dennis:group=schafroth:type=reg:size=14' AND device = 2049 AND inode = 53088266 OR filename = '<TESTBASE>/test/local/auto/older/update_both') AND peername = 'peer' ORDER BY timestamp 
SQL Query finished.
...
csync2_db_SQL: INSERT INTO dirty (filename, forced, myname, peername, operation, checktxt, device, inode, other, op, mode, type, mtime) VALUES ('<TESTBASE>/test/local/auto/older/update_both', 0, 'local', 'peer', 'NEW', 'v2:mtime=1623175200:mode=33188:user=dennis:group=schafroth:type=reg:size=14', 2049, 53088266, NULL, 2, 33188, 2, 1623175200)
