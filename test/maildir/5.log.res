...
csync_cmpchecktxt A: v2:mtime=1469461651:mode=16877:user=dennis:group=schafroth:type=dir 
csync_cmpchecktxt B: v2:mtime=1469461651:mode=16877:user=dennis:group=schafroth:type=dir 
/export/home/dennis/Projects/csync2/csync2/test/test/local/Maildir/cur has changed: 
    v2:mtime=1469461651:mode=16877:user=dennis:group=schafroth:type=dir 
DB: v2:mtime=1469461650:mode=16877:user=dennis:group=schafroth:type=dir MOD
SQL Query finished.
...
SQL: SELECT operation, filename, other, checktxt, digest, op FROM dirty WHERE (checktxt = 'v2:mtime=1469461651:mode=16877:user=dennis:group=schafroth:type=dir' OR filename = '/export/home/dennis/Projects/csync2/csync2/test/test/local/Maildir/cur') AND device = 2065 AND inode  = 811295335 AND peername = 'peer' ORDER BY timestamp 
SQL Query finished.
...
Marking File Dirty SQL: INSERT INTO dirty (filename, forced, myname, peername, operation, checktxt, device, inode, other, op, mode) VALUES ('/export/home/dennis/Projects/csync2/csync2/test/test/local/Maildir/cur', 0, 'local', 'peer', 'MOD_DIR', 'v2:mtime=1469461651:mode=16877:user=dennis:group=schafroth:type=dir', 2065, 811295335, NULL, 128, 16877)
...
Marking File Dirty SQL: INSERT INTO dirty (filename, forced, myname, peername, operation, checktxt, device, inode, other, op, mode) VALUES ('/export/home/dennis/Projects/csync2/csync2/test/test/local/Maildir/cur', 0, 'local', 'other', 'MKDIR', 'v2:mtime=1469461651:mode=16877:user=dennis:group=schafroth:type=dir', 2065, 811295335, NULL, 1, 16877)
Update file entry SQL: UPDATE file set checktxt='v2:mtime=1469461651:mode=16877:user=dennis:group=schafroth:type=dir', device=2065, inode=811295335,                 digest=NULL, mode=16877, mtime=1469461651, size=39 where filename = '/export/home/dennis/Projects/csync2/csync2/test/test/local/Maildir/cur'
...
SQL:  SELECT filename, checktxt, digest FROM file  WHERE  device = 2065  AND inode = 281308400  AND filename != '/export/home/dennis/Projects/csync2/csync2/test/test/local/Maildir/cur/1434.M21,S=6631,W=6764:2,S' AND checktxt  = 'v2:mtime=1469461647:mode=33188:user=dennis:group=schafroth:type=reg:size=8'  AND digest    = '6cb0c34bcc2b89205c6601b4edaa2eace19ec981' 
Adding textlist_add_new: /export/home/dennis/Projects/csync2/csync2/test/test/local/Maildir/cur/1434.M21,S=6631,W=6764:2,
1 files with same dev:inode (2065:281308400) as file: /export/home/dennis/Projects/csync2/csync2/test/test/local/Maildir/cur/1434.M21,S=6631,W=6764:2,S
SQL Query finished.
...
Remove old file from file db SQL: DELETE FROM file WHERE filename = '/export/home/dennis/Projects/csync2/csync2/test/test/local/Maildir/cur/1434.M21,S=6631,W=6764:2,'
...
SQL: SELECT operation, filename, other, checktxt, digest, op FROM dirty WHERE (checktxt = 'v2:mtime=1469461647:mode=33188:user=dennis:group=schafroth:type=reg:size=8' OR filename = '/export/home/dennis/Projects/csync2/csync2/test/test/local/Maildir/cur/1434.M21,S=6631,W=6764:2,S') AND device = 2065 AND inode  = 281308400 AND peername = 'peer' ORDER BY timestamp 
SQL Query finished.
...
Marking File Dirty SQL: INSERT INTO dirty (filename, forced, myname, peername, operation, checktxt, device, inode, other, op, mode) VALUES ('/export/home/dennis/Projects/csync2/csync2/test/test/local/Maildir/cur/1434.M21,S=6631,W=6764:2,S', 0, 'local', 'peer', 'MV', 'v2:mtime=1469461647:mode=33188:user=dennis:group=schafroth:type=reg:size=8', 2065, 281308400, '/export/home/dennis/Projects/csync2/csync2/test/test/local/Maildir/cur/1434.M21,S=6631,W=6764:2,', 16, 33188)
...
Found row: file '/export/home/dennis/Projects/csync2/csync2/test/test/local/Maildir/cur/1434.M21,S=6631,W=6764:2,S' clean_other: '/export/home/dennis/Projects/csync2/csync2/test/test/local/Maildir/cur/1434.M21,S=6631,W=6764:2,' result_other: '(null)' dirty: 1 operation 1 
...
Marking File Dirty SQL: INSERT INTO dirty (filename, forced, myname, peername, operation, checktxt, device, inode, other, op, mode) VALUES ('/export/home/dennis/Projects/csync2/csync2/test/test/local/Maildir/cur/1434.M21,S=6631,W=6764:2,S', 0, 'local', 'other', 'NEW', 'v2:mtime=1469461647:mode=33188:user=dennis:group=schafroth:type=reg:size=8', 2065, 281308400, NULL, 1, 33188)
Adding new file entry SQL: INSERT INTO file (filename, checktxt, device, inode, digest, mode, size, mtime) VALUES ('/export/home/dennis/Projects/csync2/csync2/test/test/local/Maildir/cur/1434.M21,S=6631,W=6764:2,S', 'v2:mtime=1469461647:mode=33188:user=dennis:group=schafroth:type=reg:size=8', 2065, 281308400, '6cb0c34bcc2b89205c6601b4edaa2eace19ec981', 33188, 8, 1469461647)
...
compare file with pattern /export/home/dennis/Projects/csync2/csync2/test/test
dirty: peer:/export/home/dennis/Projects/csync2/csync2/test/test/local/Maildir/cur/1434.M21,S=6631,W=6764:2,S 1
SQL Query finished.
...
CONN peer > 'OK (data_follows).'
read_conn_status 'OK (data_follows).' 0
CONN peer > 'v2%3Amtime=1469461651%3Amode=16877%3Auser=dennis%3Agroup=schafroth%3Atype=dir'
Flags for gencheck: 112 
csync_cmpchecktxt A: v2:mtime=1469461651:mode=16877:user=dennis:group=schafroth:type=dir 
csync_cmpchecktxt B: v2:mtime=1469461651:mode=16877:user=dennis:group=schafroth:type=dir 
...
read_conn_status 'OK (cmd_finished).' 0
Match (+): /export/home/dennis/Projects/csync2/csync2/test/test/local on /export/home/dennis/Projects/csync2/csync2/test/test/local/Maildir/cur
Setting directory time /export/home/dennis/Projects/csync2/csync2/test/test/local/Maildir/cur 1469461651.
