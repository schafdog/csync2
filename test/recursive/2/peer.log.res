...
CONN local > 'SIG 9iNlOKBHPfeAtRpsCgaQqTwKuGmEVZGB4vCM2ALNvBDDKIZDnoAaK0209kviFLAV %25test%25/recursive user/group <UID> <GID> <USER> <GROUP> <BLKSIZE> - <DIRSIZE> xxxxxxxxxx'
Command: local: SIG <TESTBASE>/test/peer/recursive user/group <UID> <GID> <USER> <GROUP> <BLKSIZE> - <DIRSIZE> xxxxxxxx
CONN local < OK (not_found).
...
CONN local > 'SIG 9iNlOKBHPfeAtRpsCgaQqTwKuGmEVZGB4vCM2ALNvBDDKIZDnoAaK0209kviFLAV %25test%25/recursive/1 user/group <UID> <GID> <USER> <GROUP> <BLKSIZE> - <DIRSIZE> xxxxxxxxxx'
Command: local: SIG <TESTBASE>/test/peer/recursive/1 user/group <UID> <GID> <USER> <GROUP> <BLKSIZE> - <DIRSIZE> xxxxxxxx
CONN local < OK (not_found).
...
CONN local > 'SIG 9iNlOKBHPfeAtRpsCgaQqTwKuGmEVZGB4vCM2ALNvBDDKIZDnoAaK0209kviFLAV %25test%25/recursive/1/2 user/group <UID> <GID> <USER> <GROUP> <BLKSIZE> - <DIRSIZE> xxxxxxxxxx'
Command: local: SIG <TESTBASE>/test/peer/recursive/1/2 user/group <UID> <GID> <USER> <GROUP> <BLKSIZE> - <DIRSIZE> xxxxxxxx
CONN local < OK (not_found).
...
CONN local > 'SIG 9iNlOKBHPfeAtRpsCgaQqTwKuGmEVZGB4vCM2ALNvBDDKIZDnoAaK0209kviFLAV %25test%25/recursive/1/2/3 user/group <UID> <GID> <USER> <GROUP> <BLKSIZE> - <DIRSIZE> xxxxxxxxxx'
Command: local: SIG <TESTBASE>/test/peer/recursive/1/2/3 user/group <UID> <GID> <USER> <GROUP> <BLKSIZE> - <DIRSIZE> xxxxxxxx
CONN local < OK (not_found).
...
CONN local > 'SIG 9iNlOKBHPfeAtRpsCgaQqTwKuGmEVZGB4vCM2ALNvBDDKIZDnoAaK0209kviFLAV %25test%25/recursive/1/2/3/4 user/group <UID> <GID> <USER> <GROUP> <BLKSIZE> - <DIRSIZE> xxxxxxxxxx'
Command: local: SIG <TESTBASE>/test/peer/recursive/1/2/3/4 user/group <UID> <GID> <USER> <GROUP> <BLKSIZE> - <DIRSIZE> xxxxxxxx
CONN local < OK (not_found).
...
CONN local > 'SETTIME 9iNlOKBHPfeAtRpsCgaQqTwKuGmEVZGB4vCM2ALNvBDDKIZDnoAaK0209kviFLAV %25test%25/recursive/1/2/3 xxxxxxxxxx'
Command: local: SETTIME <TESTBASE>/test/peer/recursive/1/2/3 xxxxxxxx        
settime <TESTBASE>/test/peer/recursive/1/2/3 rc = 0 time: 0 errno = 0 err = 
Daemon end_command <TESTBASE>/test/peer/recursive/1/2/3 SETTIME 0 
CONN local < OK (cmd_finished).

CONN local > 'SETTIME 9iNlOKBHPfeAtRpsCgaQqTwKuGmEVZGB4vCM2ALNvBDDKIZDnoAaK0209kviFLAV %25test%25/recursive/1/2 xxxxxxxxxx'
Command: local: SETTIME <TESTBASE>/test/peer/recursive/1/2 xxxxxxxx        
settime <TESTBASE>/test/peer/recursive/1/2 rc = 0 time: 0 errno = 0 err = 
Daemon end_command <TESTBASE>/test/peer/recursive/1/2 SETTIME 0 
CONN local < OK (cmd_finished).

CONN local > 'SETTIME 9iNlOKBHPfeAtRpsCgaQqTwKuGmEVZGB4vCM2ALNvBDDKIZDnoAaK0209kviFLAV %25test%25/recursive/1 xxxxxxxxxx'
Command: local: SETTIME <TESTBASE>/test/peer/recursive/1 xxxxxxxx        
settime <TESTBASE>/test/peer/recursive/1 rc = 0 time: 0 errno = 0 err = 
Daemon end_command <TESTBASE>/test/peer/recursive/1 SETTIME 0 
CONN local < OK (cmd_finished).

CONN local > 'SETTIME 9iNlOKBHPfeAtRpsCgaQqTwKuGmEVZGB4vCM2ALNvBDDKIZDnoAaK0209kviFLAV %25test%25/recursive xxxxxxxxxx'
Command: local: SETTIME <TESTBASE>/test/peer/recursive xxxxxxxx        
settime <TESTBASE>/test/peer/recursive rc = 0 time: 0 errno = 0 err = 
Daemon end_command <TESTBASE>/test/peer/recursive SETTIME 0 
CONN local < OK (cmd_finished).
...
Command: local: STAT <TESTBASE>/test/peer/recursive user/group <UID> <GID> <USER> <GROUP>    
CONN local < OK (data_follows).
...
Command: local: DEL <TESTBASE>/test/peer/recursive         
daemon_check_dirty: <TESTBASE>/test/peer/recursive
Running check for <TESTBASE>/test/peer/recursive ...
Checking for modified files <TESTBASE>/test/peer/recursive 
Checking for deleted files <TESTBASE>/test/peer/recursive.
daemon_check_dirty: <TESTBASE>/test/peer/recursive is clean
backup <TESTBASE>/test/peer/recursive 0 
6 files within directory '<TESTBASE>/test/peer/recursive': 
Deleting recursive from clean directory (<TESTBASE>/test/peer/recursive): 6 
Calling csync_rmdir_recursive local:<TESTBASE>/test/peer/recursive. Errors 0
...
daemon_check_dirty: <TESTBASE>/test/peer/recursive/1/2/3/4/5/ignored.o
Running check for <TESTBASE>/test/peer/recursive/1/2/3/4/5/ignored.o ...
Checking for modified files <TESTBASE>/test/peer/recursive/1/2/3/4/5/ignored.o 
No match. Don't check at all: <TESTBASE>/test/peer/recursive/1/2/3/4/5/ignored.o
Checking for deleted files <TESTBASE>/test/peer/recursive/1/2/3/4/5/ignored.o.
daemon_check_dirty: <TESTBASE>/test/peer/recursive/1/2/3/4/5/ignored.o is clean
Removing file <TESTBASE>/test/peer/recursive/1/2/3/4/5/ignored.o
Locking 'DELETE:<TESTBASE>/test/peer/recursive/1/2/3/4/5/ignored.o'
Removing <TESTBASE>/test/peer/recursive/1/2/3/4/5/ignored.o from file db.
remove_file SQL: DELETE FROM file WHERE hostname = ?  AND  filename = ? , param1: <TESTBASE>/test/peer/recursive/1/2/3/4/5/ignored.o, param2: peer
daemon_check_dirty: <TESTBASE>/test/peer/recursive/1/2/3/4/5/ignored.c~
Running check for <TESTBASE>/test/peer/recursive/1/2/3/4/5/ignored.c~ ...
Checking for modified files <TESTBASE>/test/peer/recursive/1/2/3/4/5/ignored.c~ 
No match. Don't check at all: <TESTBASE>/test/peer/recursive/1/2/3/4/5/ignored.c~
Checking for deleted files <TESTBASE>/test/peer/recursive/1/2/3/4/5/ignored.c~.
daemon_check_dirty: <TESTBASE>/test/peer/recursive/1/2/3/4/5/ignored.c~ is clean
Removing file <TESTBASE>/test/peer/recursive/1/2/3/4/5/ignored.c~
Locking 'DELETE:<TESTBASE>/test/peer/recursive/1/2/3/4/5/ignored.c~'
Removing <TESTBASE>/test/peer/recursive/1/2/3/4/5/ignored.c~ from file db.
remove_file SQL: DELETE FROM file WHERE hostname = ?  AND  filename = ? , param1: <TESTBASE>/test/peer/recursive/1/2/3/4/5/ignored.c~, param2: peer
daemon_check_dirty: <TESTBASE>/test/peer/recursive/1/2/3/4/5/file.c
Running check for <TESTBASE>/test/peer/recursive/1/2/3/4/5/file.c ...
Checking for modified files <TESTBASE>/test/peer/recursive/1/2/3/4/5/file.c 
Checking for deleted files <TESTBASE>/test/peer/recursive/1/2/3/4/5/file.c.
...
Called csync_rmdir_recursive local:<TESTBASE>/test/peer/recursive. RC: 1 35
Deleted recursive from clean directory (<TESTBASE>/test/peer/recursive): 6 1 
DEL local:<TESTBASE>/test/peer/recursive rc: 1
remove_file SQL: DELETE FROM file WHERE hostname = ?  AND  filename = ? , param1: <TESTBASE>/test/peer/recursive, param2: peer
Updated(del) local:<TESTBASE>/test/peer/recursive  
Daemon end_command <TESTBASE>/test/peer/recursive DEL 1 
IDENT (cmd_finished).
CONN local < IDENT (cmd_finished).
...
Deleted recursive from clean directory (<TESTBASE>/test/peer): 0 1 
