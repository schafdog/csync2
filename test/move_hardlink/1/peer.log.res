...
SQL MOVE: 'UPDATE file set filename = concat(?,substring(filename,length(?)+1)) WHERE (filename = ? or filename like ?)' '<TESTBASE>/test/peer/Maildir/cur/123,Sab' <TESTBASE>/test/peer/Maildir/tmp/123 '<TESTBASE>/test/peer/Maildir/tmp/123' '<TESTBASE>/test/peer/Maildir/tmp/123/%'
DAEMON_MV: 1 rows
