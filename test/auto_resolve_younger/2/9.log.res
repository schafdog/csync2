...
check_old_operation: RM(64) Old operation: NEW(2) '<TESTBASE>/test/local/auto/younger/local_oldest' '(null)'
...
check_old_operation: RM(64) Old operation: MKDIR(1) '<TESTBASE>/test/local/auto/younger' '(null)'
...
check_old_operation: RM(64) Old operation: MKDIR(1) '<TESTBASE>/test/local/auto' '(null)'
...
Dirty (missing) item <TESTBASE>/test/local/auto RM NULL 0
Skipping matched file (<TESTBASE>/test/local/auto) from deleted directory (<TESTBASE>/test/local/)
Dirty (missing) item <TESTBASE>/test/local/auto/younger RM NULL 0
Skipping matched file (<TESTBASE>/test/local/auto/younger) from deleted directory (<TESTBASE>/test/local/)
Dirty (missing) item <TESTBASE>/test/local/auto/younger/local_oldest RM NULL 0
