...
check_old_operation: MOD_DIR(129) Old operation: MKDIR(1) '<TESTBASE>/test/local/auto/younger' '(null)'
...
check_old_operation: MOD(130) Old operation: NEW(2) '<TESTBASE>/test/local/auto/younger/local_oldest' '(null)'
