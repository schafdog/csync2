...
CONN peer < SIG %25test%25/auto/younger user/group 1234 1000 dennis schafroth 16877 - 1626134441 4096 
...
>>> peer:	v2:mtime=1626134440:mode=16877:user=dennis:group=schafroth:type=dir
>>> LOCAL:	v2:mtime=1626134441:mode=16877:user=dennis:group=schafroth:type=dir
...
CONN peer < MKDIR %25test%25/auto/younger - 1234 1000 dennis schafroth 16877 - 1626134441 4096 
...
CONN peer < SIG %25test%25/auto/younger/peer_oldest user/group 1234 1000 dennis schafroth 33188 - 1626134441 14 
CONN peer > 'OK (data_follows).'
update_file_sig /export/home/dennis/Projects/csync2/csync2/test/test/local/auto/younger/peer_oldest RC 0
CONN peer > 'v2%3Amtime=xxxxxxxxxx%3Amode=33188%3Auser=dennis%3Agroup=schafroth%3Atype=reg%3Asize=12'
File is different on peer (cktxt char #-1).
>>> peer:	v2:mtime=1626134440:mode=33188:user=dennis:group=schafroth:type=reg:size=12
>>> LOCAL:	v2:mtime=1626134441:mode=33188:user=dennis:group=schafroth:type=reg:size=14
...
Csync2 / Librsync: csync_rs_check('/export/home/dennis/Projects/csync2/csync2/test/test/local/auto/younger/peer_oldest', 1 [regular file])
CONN peer > 'octet-stream 32'
Content length in buffer: 'octet-stream 32' size: 32 rc: 0 
rs_check: Found diff in sig at -32:-0
File is different on peer (rsync sig).
...
CONN peer < PATCH %25test%25/auto/younger/peer_oldest - 1234 1000 dennis schafroth 33188 - 1626134441 14 
...
update_directory: Setting directory time /export/home/dennis/Projects/csync2/csync2/test/test/local/auto/younger 1626134441.
