...
dirty host other 
dirty host peer 
DIRTY LOOKUP: '<TESTBASE>/test/local/auto/younger/local_oldest' 'v2:mtime=<MTIME>mode=33188:user=<USER>:group=<GROUP>:type=reg:size=12'
...
has links: file <TESTBASE>/test/local/auto/younger/local_oldest checktxt 'v2:mtime=<MTIME>mode=33188:user=<USER>:group=<GROUP>:type=reg:size=12' 1 true
