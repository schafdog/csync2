...
Redis reply: SET '<TESTBASE>/test/local' '1736899510' NX EX 60 -> OK
csync_redis_lock: OK <TESTBASE>/test/local 1736899510
...
has links: file <TESTBASE>/test/local checktxt 'v2:mtime=1625695200:mode=16877:user=dennis:group=schafroth:type=dir' 3 0
MKDIR rc: 16
...
Redis reply: SET '<TESTBASE>/test/local/auto' '1736899510' NX EX 60 -> OK
csync_redis_lock: OK <TESTBASE>/test/local/auto 1736899510
...
has links: file <TESTBASE>/test/local/auto checktxt 'v2:mtime=1625695200:mode=16877:user=dennis:group=schafroth:type=dir' 3 0
MKDIR rc: 16
...
Redis reply: SET '<TESTBASE>/test/local/auto/younger' '1736899510' NX EX 60 -> OK
csync_redis_lock: OK <TESTBASE>/test/local/auto/younger 1736899510
...
Sould send FLUSH peer:<TESTBASE>/test/local/auto/younger (won auto resolved)
...
has links: file <TESTBASE>/test/local/auto/younger checktxt 'v2:mtime=1625695200:mode=16877:user=dennis:group=schafroth:type=dir' 2 0
MKDIR rc: 16
...
Sould send FLUSH peer:<TESTBASE>/test/local/auto/younger/local_oldest (won auto resolved)
...
has links: file <TESTBASE>/test/local/auto/younger/local_oldest checktxt 'v2:mtime=1625695200:mode=33188:user=dennis:group=schafroth:type=reg:size=14' 1 1
...
Match (+): <TESTBASE>/test/local/auto/younger on <TESTBASE>/test/local/auto/younger
uid dennis gid schafroth
update_directory: Setting directory time <TESTBASE>/test/local/auto/younger 1625695200.
CONN peer < SETTIME %25test%25/auto/younger 
CONN peer > 'OK (cmd_finished).'
read_conn_status 'OK (cmd_finished).' 0
Match (+): <TESTBASE>/test/local on <TESTBASE>/test/local/auto
uid dennis gid schafroth
update_directory: Setting directory time <TESTBASE>/test/local/auto 1625695200.
CONN peer < SETTIME %25test%25/auto 
CONN peer > 'OK (cmd_finished).'
read_conn_status 'OK (cmd_finished).' 0
Match (+): <TESTBASE>/test/local on <TESTBASE>/test/local
uid dennis gid schafroth
update_directory: Setting directory time <TESTBASE>/test/local 1625695200.
