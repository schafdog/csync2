...
Inserted/updated <TESTBASE>/test/local/tmp rows matched: 1
...
has links: file <TESTBASE>/test/local/tmp checktxt 'v2:mtime=<MTIME>mode=16877:user=<USER>:group=<GROUP>:type=dir' 2 false
MKDIR rc: 16
...
Directory time <TESTBASE>/test/local <TESTBASE>/test/local/tmp
