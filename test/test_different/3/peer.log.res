...
DEBUG daemon: SIG rc=0 'local' '<TESTBASE>/test/peer/different' '-' 
...
Match (+): <TESTBASE>/test/peer on <TESTBASE>/test/peer/different
Redis reply: GET 'CLOSE_WRITE,CLOSE:<TESTBASE>/test/peer/different' -> NULL
...
File <TESTBASE>/test/peer/different. Hostname: peer 
Match (+): <TESTBASE>/test/peer on <TESTBASE>/test/peer/different
daemon_check_dirty: <TESTBASE>/test/peer/different is just marked dirty
DbSql::is_dirty <TESTBASE>/test/peer/different:local 2 33188
...
Match (+): <TESTBASE>/test/peer on <TESTBASE>/test/peer/different
daemon_check_dirty: <TESTBASE>/test/peer/different is clean
DEBUG daemon: FLUSH rc=0 'local' '<TESTBASE>/test/peer/different' '-' 
...
Reading chunk 10 bytes of 10
Writing chunk 10 bytes of 10 to file
...
Redis reply: SET 'CLOSE_WRITE,CLOSE:<TESTBASE>/test/peer/.different.XXXXXX' '<MTIME>' NX EX 1 -> OK
Running rs_patch_file() from librsync..
Renaming tmp file to orig. filename..
Locking 'MOVED_TO:<TESTBASE>/test/peer/different'
Redis reply: SET 'MOVED_TO:<TESTBASE>/test/peer/different' '<MTIME>' NX EX 1 -> OK
...
DEBUG daemon: PATCH rc=1 'local' '<TESTBASE>/test/peer/different' '-' 
daemon_file_update: UPDATE/INSERT into file filename: <TESTBASE>/test/peer/different
daemon_file_update DONE: UPDATE/INSERT into file filename: <TESTBASE>/test/peer/different
...
DEBUG daemon: SIG rc=0 'local' '<TESTBASE>/test/peer/tmp' '-' 
...
Match (+): <TESTBASE>/test/peer on <TESTBASE>/test/peer/tmp
Redis reply: GET 'CLOSE_WRITE,CLOSE:<TESTBASE>/test/peer/tmp' -> NULL
...
File <TESTBASE>/test/peer/tmp. Hostname: peer 
Match (+): <TESTBASE>/test/peer on <TESTBASE>/test/peer/tmp
daemon_check_dirty: <TESTBASE>/test/peer/tmp is just marked dirty
DbSql::is_dirty <TESTBASE>/test/peer/tmp:local 1 16877
...
DEBUG daemon: MOD rc=1 'local' '<TESTBASE>/test/peer/tmp' '-' 
daemon_file_update: UPDATE/INSERT into file filename: <TESTBASE>/test/peer/tmp
daemon_file_update DONE: UPDATE/INSERT into file filename: <TESTBASE>/test/peer/tmp
