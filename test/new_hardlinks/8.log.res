...
>>> peer:	v2:mtime=1733439431:mode=16877:user=dennis:group=schafroth:type=dir
>>> LOCAL:	v2:mtime=1733439432:mode=16877:user=dennis:group=schafroth:type=dir
...
CONN peer < MKHARDLINK %25test%25/new/hardlinked_2 %25test%25/new/hardlinked_4 
CONN peer > 'OK (cmd_finished).'
...
CONN peer > 'v2%3Amtime=xxxxxxxxxx%3Amode=33188%3Auser=dennis%3Agroup=schafroth%3Atype=reg%3Asize=4'
Csync2 / Librsync: csync_rs_check('/export/home/dennis/Projects/csync2/csync2/test/test/local/new/hardlinked_4', 1 [regular file])
CONN peer > 'octet-stream 32'
Got octet-stream 32
Content length in buffer: 'octet-stream 32' size: 32 rc: 0 (octet-stream)
CONN peer > 'OK (cmd_finished).'
