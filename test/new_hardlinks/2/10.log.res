...
DB Version:    2
IP Version:    IPv4
dirty: peer:<TESTBASE>/test/local/new/hardlinked_6 v2:mtime=xxxxxxxxxx:mode=33188:user=dennis:group=schafroth:type=reg:size=4 ''
dirty: peer:<TESTBASE>/test/local/new/was_hardlink v2:mtime=xxxxxxxxxx:mode=33188:user=dennis:group=schafroth:type=reg:size=4 ''
