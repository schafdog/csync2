...
do hardlink check <TESTBASE>/test/local/new/hardlinked_4 <TESTBASE>/test/local/new/hardlinked_5 
...
Remote HARDLINK file (<TESTBASE>/test/local/new/hardlinked_5) not identical. Need patching. RC = 32
check_update_hardlink result: <TESTBASE>/test/local/new/hardlinked_5 -> <TESTBASE>/test/local/new/hardlinked_4: 32
Not a candidate for HARDLINK <TESTBASE>/test/local/new/hardlinked_5 -> <TESTBASE>/test/local/new/hardlinked_4
...
Candidate for HARDLINK <TESTBASE>/test/local/new/hardlinked_2 -> <TESTBASE>/test/local/new/hardlinked_4
do hardlink check <TESTBASE>/test/local/new/hardlinked_4 <TESTBASE>/test/local/new/hardlinked_2 
CONN peer < SIG %25test%25/new/hardlinked_2 user/group 1234 1000 dennis schafroth 33188 32a0617aab4c9fe725f1b5bc441291180ad25b73 4 
CONN peer > 'OK (data_follows).'
update_file_sig <TESTBASE>/test/local/new/hardlinked_2 RC 0
...
CONN peer > 'OK (not_found).'
update_file_sig <TESTBASE>/test/local/new/hardlinked_5 RC 32
CHECKING SAME DEV INODE <TESTBASE>/test/local/new/hardlinked_5 '32a0617aab4c9fe725f1b5bc441291180ad25b73'
5 files with same dev:inode (2049:0) as file: <TESTBASE>/test/local/new/hardlinked_5
check same file (32) <TESTBASE>/test/local/new/hardlinked_4 -> <TESTBASE>/test/local/new/hardlinked_5 
...
CONN peer > 'OK (data_follows).'
update_file_sig <TESTBASE>/test/local/new/hardlinked_4 RC 0
CONN peer > 'v2%3Amtime=xxxxxxxxxx%3Amode=33188%3Auser=dennis%3Agroup=schafroth%3Atype=reg%3Asize=4'
CONN peer > 'octet-stream 32'
Got octet-stream 32
Content length in buffer: 'octet-stream 32' size: 32 rc: 0 (octet-stream)
rs_check: Receiving signature 32 bytes for <TESTBASE>/test/local/new/hardlinked_4
CONN peer > 'OK (cmd_finished).'
?S: peer            <TESTBASE>/test/local/new/hardlinked_4
...
Candidate for HARDLINK <TESTBASE>/test/local/new/hardlinked_4 -> <TESTBASE>/test/local/new/hardlinked_5
do hardlink check <TESTBASE>/test/local/new/hardlinked_5 <TESTBASE>/test/local/new/hardlinked_4 
CONN peer < SIG %25test%25/new/hardlinked_4 user/group 1234 1000 dennis schafroth 33188 32a0617aab4c9fe725f1b5bc441291180ad25b73 4 
CONN peer > 'OK (data_follows).'
update_file_sig <TESTBASE>/test/local/new/hardlinked_4 RC 0
