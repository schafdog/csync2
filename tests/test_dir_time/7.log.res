...
mark operation NEW -> MOD => NEW other:/export/home/dennis/Projects/csync2/csync2/tests/test/local/usr/local (not synced) .
...
mark operation NEW -> MOD => NEW other:/export/home/dennis/Projects/csync2/csync2/tests/test/local/usr/local/sbin (not synced) .
